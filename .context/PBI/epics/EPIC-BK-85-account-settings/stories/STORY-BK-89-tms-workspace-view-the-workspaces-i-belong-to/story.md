...
- [BK-136](https://jira.upexgalaxy.com/browse/BK-136): BK-89: TC01: GET /api/v1/workspaces returns HTTP 200 with correct workspace list shape _(Borrador)_
- [BK-139](https://jira.upexgalaxy.com/browse/BK-139): BK-89: TC02: GET /api/v1/workspaces unauthenticated returns 401 _(Borrador)_
- [BK-140](https://jira.upexgalaxy.com/browse/BK-140): BK-89: TC03: GET /api/v1/workspaces returns only active memberships — DB cross-validation _(Borrador)_
- [BK-141](https://jira.upexgalaxy.com/browse/BK-141): BK-89: TC04: GET /api/v1/workspaces does not return role field — BLOCKER confirmed _(Borrador)_
